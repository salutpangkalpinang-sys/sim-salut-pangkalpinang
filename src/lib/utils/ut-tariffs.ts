...
export const UT_OFFICIAL_GENERAL_FEES = {
  ...
  ADMISION_PASCASARJANA: { name: "Biaya Admisi Pendaftaran Pascasarjana (S2/S3)", amount: 750000, unit: "Per Pendaftaran" },
  RPL: { name: "Biaya Rekognisi Pembelajaran Lampau (RPL)", amount: 300000, unit: "Per Pengusulan" },
  WISUDA: { name: "Biaya Wisuda Resmi UT", amount: 750000, unit: "Per Mahasiswa" },
  ADMIN_WISUDA_SALUT: { name: "Biaya Admin & Pendampingan Wisuda SALUT", amount: 100000, unit: "Per Mahasiswa" },
  ALMAMATER: { name: "Biaya Jaket Almamater UT", amount: 200000, unit: "Per Atribut" },
  EKTM: { name: "Biaya Cetak E-KTM Fisik", amount: 15000, unit: "Per Kartu" },
  ADMINISTRASI_SALUT_PASCASARJANA: { name: "Biaya Administrasi SALUT Pascasarjana (S2/S3)", amount: 500000, unit: "Per Mahasiswa" },
  PRAKTIK_MENGAJAR_PKM: { name: "Praktik Kemampuan Mengajar (PKM FKIP)", amount: 700000, unit: "Per Mahasiswa" },
  TAPS_ARTIKEL_ILMIAH: { name: "Artikel Ilmiah (TAPS / Karya Ilmiah)", amount: 400000, unit: "Per Registrasi Ulang / MK" },
  TAPS_UKT: { name: "UKT (Ujian Komprehensif Tertulis)", amount: 400000, unit: "Per Registrasi Ulang / MK" },
  ADMIN_BANK: { name: "Biaya Administrasi Bank", amount: 0, unit: "Sesuai Biaya Mitra Bank" },
  BAHAN_AJAR_NON_SIPAS: { name: "Total Biaya Buku / Bahan Ajar Cetak (NON-SIPAS)", amount: 0, unit: "Sesuai Judul Buku (TBO Karunika)" },
